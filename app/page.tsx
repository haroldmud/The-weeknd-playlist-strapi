      ...
      <Layout>
        <div>
          <div className="register w-5/12 mx-auto p-8 mt-32 rounded-lg">
            ...
            <Link href={'/playlists'} type="submit" className="text-sm bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 px-4 font-semibold shadow-sm rounded-md hover:bg-blue-900 text-blue-100 p-2">Find your Fav Song</Link>
          </div>
        </div>
      </Layout>
    </>
