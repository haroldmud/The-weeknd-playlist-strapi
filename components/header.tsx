...
export default function Header() {
  const logged = useSelector<any>((state) => state.logged.value);
        ...
        <div className="flex gap-4 text-gray-500">
          ...
          {!logged ? (
            <form onSubmit={handleLogin} className="flex gap-2">
              <input
                className="pl-2 placeholder:text-[12px] text-[12px] py-1 bg-transparent header border border-gray-500 outline-1 rounded-sm"
                required
                type="text"
